    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index.html" class="logo">
                ...
                <span class="logo-mini"><b>二货网</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>二货网-运营商后台</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">${login.cname }</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
...
<%-- 				    <li class="treeview">
				        ...
				        <ul class="treeview-menu">
				            ...
				            <li id="admin-login">
				                <a href="${pageContext.request.contextPath}/admin/seller_1.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>商家审核
				                </a>
				            </li>
							<li id="admin-login">
				                 <a href="${pageContext.request.contextPath}/admin/seller.jsp" target="iframe">
					...
					<li class="treeview">
				        ...
				        <ul class="treeview-menu">
				            ...
				            <li id="admin-login">
				                <a href="brand.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>品牌管理
				                </a>
				            </li>
<!-- 							<li id="admin-login">
				                <a href="specification.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>规格管理
				                </a>
				            </li>	 -->						
							<li id="admin-login">
				                <a href="type_template.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>分类管理
				                </a>
				            </li>
							<!-- <li id="admin-login">
				                <a href="item_cat.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>分类管理
				                </a>
				            </li> -->
							<li id="admin-login">
				                <a href="goods.jsp" target="iframe">
					...
					<li class="treeview">
				        ...
				        <ul class="treeview-menu">
				            ...
				            <li id="admin-login">
				                <a href="content_category.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>广告类型管理
				                </a>
				            </li>
							<li id="admin-login">
				                <a href="content.jsp" target="iframe">
