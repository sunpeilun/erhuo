    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		...
    		$.post(url,params,function(data){
    			...
    			$(data).each(function(i){
    				...
    				//xzId
    				$(cloneObj).find("#xzId").append("<input type='hidden' value='"+obj.sjId+"'/>");
    				 ...
    				 $(cloneObj).find("#spanId").html(obj.state);
    	...
    	function selectOne(sjId){
    		...
    		$.post(url,params,function(data){
    			...
    			var xqObj = $("#xqId");
    			$(xqObj).find(":hidden").val(data.sjId)
    		},"json");
    	}
    </script>
</head>
                        ...
                        <div class="table-box">
                            ...
                            <div class="box-tools pull-right">
                                <div class="has-feedback">
									...
									状态：
									<input type="radio"  value=""  checked="checked"  name="state"/>全部
									<input type="radio" value="待审核" name="state" />待审核
									<input type="radio" value="已审核" name="state"/>审核通过
									<input type="radio" value="审核未通过" name="state"/>审核未通过
									<input type="radio" value="关闭商家" name="state"/>关闭商家
                            ...
                            <!--工具栏/-->
			                  ...
			                  <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
			                     ...
			                     <tbody id="tbodyId">
			                      		<tr id="trId">
			                              <td id="xzId"><input  type="checkbox" class="checkbox" ></td>			                              
				                          <td id="sjId"></td>
									      <td id="cname"></td>
									      <td id="sId"></td>
									      <td id="linkId"></td>
  ...
  <div class="modal-dialog modal-lg" >
	<div class="modal-content">
		...
		<div class="modal-footer" id="xqId">						
			<button class="btn btn-success" data-dismiss="modal" aria-hidden="true" id="stbtn" onclick="shenghe(this)">审核通过</button>
         	<button class="btn btn-danger"  data-dismiss="modal" aria-hidden="true" id="swtbtn" onclick="shenghe(this)">审核未通过</button>
